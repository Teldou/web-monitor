...
class GetRecentStickers(Object):
    """
    Attributes:
        ID (:obj:`int`): ``0x5ea192c9``

    Args:
        hash: :obj:`int`
        attached: :obj:`bool` (optional)

    Returns:
        :class:`pyrogram.api.types.messages.RecentStickersNotModified` | :class:`pyrogram.api.types.messages.RecentStickers`
