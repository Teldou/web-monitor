...
class InstallStickerSet(Object):
    ...
    Returns:
        :class:`pyrogram.api.types.messages.StickerSetInstallResultSuccess` | :class:`pyrogram.api.types.messages.StickerSetInstallResultArchive`
