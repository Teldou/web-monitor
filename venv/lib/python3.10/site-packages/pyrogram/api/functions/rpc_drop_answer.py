...
class RpcDropAnswer(Object):
    """
    Attributes:
        ID (:obj:`int`): ``0x58e4a740``

    Args:
        req_msg_id: :obj:`int`

    Returns:
        :class:`pyrogram.api.types.RpcAnswerUnknown` | :class:`pyrogram.api.types.RpcAnswerDroppedRunning` | :class:`pyrogram.api.types.RpcAnswerDropped`
