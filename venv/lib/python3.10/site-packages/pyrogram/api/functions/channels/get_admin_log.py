...
class GetAdminLog(Object):
    ...
    Args:
        ...
        min_id: :obj:`int`
        limit: :obj:`int`
        events_filter: :class:`pyrogram.api.types.ChannelAdminLogEventsFilter` (optional)
        admins: List of :class:`pyrogram.api.types.InputUser` (optional)

    Returns:
        :class:`pyrogram.api.types.channels.AdminLogResults`
