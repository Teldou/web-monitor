...
class GetParticipants(Object):
    """
    Attributes:
        ID (:obj:`int`): ``0x123e05e9``

    Args:
        channel: :class:`pyrogram.api.types.InputChannel`
        filter: :class:`pyrogram.api.types.ChannelParticipantsFilter`
        offset: :obj:`int`
        limit: :obj:`int`
        hash: :obj:`int`

    Returns:
        :class:`pyrogram.api.types.channels.ChannelParticipants` | :class:`pyrogram.api.types.channels.ChannelParticipantsNotModified`
