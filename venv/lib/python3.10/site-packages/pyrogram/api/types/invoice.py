...
class Invoice(Object):
    """
    Attributes:
        ID (:obj:`int`): ``0xc30aa358``

    Args:
        currency: :obj:`string`
        prices: List of :class:`pyrogram.api.types.LabeledPrice`
        test: :obj:`bool` (optional)
        name_requested: :obj:`bool` (optional)
        phone_requested: :obj:`bool` (optional)
        email_requested: :obj:`bool` (optional)
        shipping_address_requested: :obj:`bool` (optional)
        flexible: :obj:`bool` (optional)
        phone_to_provider: :obj:`bool` (optional)
        email_to_provider: :obj:`bool` (optional)
    """
    ID = 0xc30aa358
