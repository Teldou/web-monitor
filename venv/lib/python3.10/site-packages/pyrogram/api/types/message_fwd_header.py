...
class MessageFwdHeader(Object):
    """
    Attributes:
        ID (:obj:`int`): ``0x559ebe6d``

    Args:
        date: :obj:`int`
        from_id: :obj:`int` (optional)
        channel_id: :obj:`int` (optional)
        channel_post: :obj:`int` (optional)
        post_author: :obj:`string` (optional)
        saved_from_peer: :class:`pyrogram.api.types.Peer` (optional)
        saved_from_msg_id: :obj:`int` (optional)
    """
    ID = 0x559ebe6d
