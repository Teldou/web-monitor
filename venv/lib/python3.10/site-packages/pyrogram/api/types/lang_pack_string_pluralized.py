...
class LangPackStringPluralized(Object):
    """
    Attributes:
        ID (:obj:`int`): ``0x6c47ac9f``

    Args:
        key: :obj:`string`
        other_value: :obj:`string`
        zero_value: :obj:`string` (optional)
        one_value: :obj:`string` (optional)
        two_value: :obj:`string` (optional)
        few_value: :obj:`string` (optional)
        many_value: :obj:`string` (optional)
    """
    ID = 0x6c47ac9f
