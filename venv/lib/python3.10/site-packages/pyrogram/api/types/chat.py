...
class Chat(Object):
    ...
    Args:
        ...
        kicked: :obj:`bool` (optional)
        left: :obj:`bool` (optional)
        admins_enabled: :obj:`bool` (optional)
        admin: :obj:`bool` (optional)
        deactivated: :obj:`bool` (optional)
        migrated_to: :class:`pyrogram.api.types.InputChannel` (optional)
    """
    ID = 0xd91cdd54
